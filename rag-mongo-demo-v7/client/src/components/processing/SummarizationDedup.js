                    ...
                    <CardContent>
                      ...
                      <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} sm={6} md={3}>
                          ...
                          <Typography variant="h6">
                            {summary.tokens.prompt.toLocaleString()}
                          </Typography>
                          <Typography variant="caption" color="text.secondary">
                            ${summary.cost.input}
                          </Typography>
                        ...
                        <Grid item xs={12} sm={6} md={3}>
                          ...
                          <Typography variant="h6">
                            {summary.tokens.completion.toLocaleString()}
                          </Typography>
                          <Typography variant="caption" color="text.secondary">
                            ${summary.cost.output}
                          </Typography>
                        ...
                        <Grid item xs={12} sm={6} md={3}>
                          ...
                          <Typography variant="caption" color="text.secondary">
                            {summary.tokens.total.toLocaleString()} tokens
                          </Typography>
                        </Grid>
                      </Grid>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        Pricing: $0.150 per 1M input tokens, $0.600 per 1M output tokens (gpt-4o-mini)
                      </Typography>
                    </CardContent>
                  </Card>
                </>
